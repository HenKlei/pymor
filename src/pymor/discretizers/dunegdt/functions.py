...
if config.HAVE_DUNEGDT:
    ...
    from dune.xt.functions import ConstantFunction as DuneXTConstantFunction
    from dune.xt.functions import GridFunction as DuneXTGridFunction
    from dune.xt.grid import Dim

    from pymor.algorithms.rules import NoMatchingRuleError, RuleNotMatchingError, RuleTable, match_class, match_generic
    from pymor.analyticalproblems.functions import ConstantFunction, Function, LincombFunction, ProductFunction
    from pymor.core.base import BasicObject, classinstancemethod
